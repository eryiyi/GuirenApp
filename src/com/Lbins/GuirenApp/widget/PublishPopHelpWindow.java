...
public class PublishPopHelpWindow extends PopupWindow {
    private TextView btn_cancle, btn_sure;
    private View mMenuView;

    public PublishPopHelpWindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.publish_help_foot, null);
