...
import com.Lbins.GuirenApp.huanxin.domain.VideoEntity;
import com.Lbins.GuirenApp.huanxin.video.util.ImageCache;
import com.Lbins.GuirenApp.huanxin.video.util.ImageResizer;
import com.Lbins.GuirenApp.huanxin.video.util.Utils;
import com.Lbins.GuirenApp.huanxin.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(R.drawable.no_data);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if(position==0)
			{
				...
				holder.imageView.setImageResource(R.drawable.no_data);
