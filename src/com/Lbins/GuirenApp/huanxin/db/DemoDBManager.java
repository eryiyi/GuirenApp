package com.Lbins.GuirenApp.huanxin.db;
...
import com.Lbins.GuirenApp.huanxin.domain.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(GuirenApplication.getInstance().getApplicationContext());
    }
