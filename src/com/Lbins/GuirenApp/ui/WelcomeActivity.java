    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        if (amapLocation != null) {
            if (amapLocation.getErrorCode() == 0) {
                ...
                GuirenApplication.locationProvinceName = String.valueOf(amapLocation.getProvince());
                GuirenApplication.locationCityName = String.valueOf(amapLocation.getCity());
                GuirenApplication.locationAreaName = String.valueOf(amapLocation.getDistrict());
