 ...
 * 类的功能、说明写在此处.
 */
public class PublishTvCommentAcitvity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.publish_comment_run:
                ...
                progressDialog = new CustomProgressDialog(PublishTvCommentAcitvity.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void publish_comment() {
        StringRequest request = new StringRequest(
                Request.Method.POST,
                InternetURL.PUBLISH_VIDEO_COMMENT_RECORD_TV,
                    ...
                    public void onResponse(String s) {
                        ...
                        if (StringUtil.isJson(s)) {
                            ...
                            if (Integer.parseInt(data.getCode()) == 200) {
                                Toast.makeText(PublishTvCommentAcitvity.this, R.string.comment_success, Toast.LENGTH_SHORT).show();
                                //调用广播，刷新详细页评论
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        publish_comment_run.setClickable(true);
                        Toast.makeText(PublishTvCommentAcitvity.this, R.string.comment_error_one, Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
    ...
    private void Init_viewPager() {
        ...
        for (int i = 0; i < emojis.size(); i++) {
            ...
            FaceAdapter adapter = new FaceAdapter(PublishTvCommentAcitvity.this, emojis.get(i));
