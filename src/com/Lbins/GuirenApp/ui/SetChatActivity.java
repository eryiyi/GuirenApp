...
import com.Lbins.GuirenApp.huanxin.DemoModel;
import com.Lbins.GuirenApp.huanxin.ui.BlacklistActivity;
import com.Lbins.GuirenApp.huanxin.ui.DiagnoseActivity;
import com.Lbins.GuirenApp.huanxin.ui.OfflinePushNickActivity;
import com.Lbins.GuirenApp.huanxin.ui.UserProfileActivity;
...
//			RedPacketUtil.startChangeActivity(getActivity());
            ...
            case R.id.ll_black_list:
                startActivity(new Intent(SetChatActivity.this, BlacklistActivity.class));
                break;
            case R.id.ll_diagnose:
                startActivity(new Intent(SetChatActivity.this, DiagnoseActivity.class));
                break;
            case R.id.ll_set_push_nick:
                startActivity(new Intent(SetChatActivity.this, OfflinePushNickActivity.class));
                break;
            case R.id.ll_user_profile:
                startActivity(new Intent(SetChatActivity.this, UserProfileActivity.class).putExtra("setting", true)
    ...
    void logout() {
        final ProgressDialog pd = new ProgressDialog(SetChatActivity.this);
            ...
            public void onSuccess() {
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        // show login screen
                        finish();
                        startActivity(new Intent(SetChatActivity.this, com.Lbins.GuirenApp.huanxin.ui.LoginActivity.class));
            ...
            public void onError(int code, String message) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        pd.dismiss();
                        Toast.makeText(SetChatActivity.this, "unbind devicetokens failed", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
