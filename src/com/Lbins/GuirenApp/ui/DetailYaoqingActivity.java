...
public class DetailYaoqingActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.head:
            {
                Intent intent = new Intent(DetailYaoqingActivity.this, ProfileActivity.class);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (Integer.parseInt(data.getCode()) == 200) {
                                showMsg(DetailYaoqingActivity.this, "操作成功！");
                                finish();
                            } else {
                                showMsg(DetailYaoqingActivity.this, "操作失败");
                            }
                        } else {
                            showMsg(DetailYaoqingActivity.this, "操作失败");
                        }
