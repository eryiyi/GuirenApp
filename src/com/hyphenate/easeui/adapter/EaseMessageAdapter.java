...
import com.hyphenate.easeui.widget.chatrow.*;
...
public class EaseMessageAdapter extends BaseAdapter{
	...
	protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
		...
		if(emp != null){
//			imageLoader.displayImage(emp.getMm_emp_cover(), chatRow.userAvatarView, GuirenApplication.txOptions);
			imageLoader.displayImage(emp.getMm_emp_cover(), chatRow.userAvatarView, GuirenApplication.txOptions, animateFirstListener);
...
//	private void getEmp(final String username,final ImageView view) {
...
//									imageLoader.displayImage(empInfo.getMm_emp_cover(), view , GuirenApplication.txOptions);
//								}
//
//							} else {
//
